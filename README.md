...
### 1.3. Context Window
Model이 수용할 수 있는 내용(Context Window)은 한계가 있습니다. 이 수용 한계는 토큰(token)의 숫자로 정의됩니다. 2026년 7월 기준 대부분의 소형 모델은 128K, 중형 모델은 256K 토큰까지, 그보다 큰 모델은 1M 토큰까지 수용할 수 있습니다.

Context Window가 한계에 도달하면 Context를 자르거나, 초기화하거나, 도달 전 Context를 압축해야 합니다.
